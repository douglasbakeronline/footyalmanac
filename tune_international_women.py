...
Data: martj42/womens-international-results on GitHub — every international match
...
can be tested, not guessed.
    ...
    python3 tune_international_women.py --report        fit, validate, print, write nothing
    python3 tune_international_women.py --fit            as above, write international-women.json if it PASSES
    python3 tune_international_women.py --fit --dry-run  fit and print the verdict, write nothing
...
DATA_URL = "https://raw.githubusercontent.com/martj42/womens-international-results/master/results.csv"
EPS = 1e-12
MAXG = E.MAX_GOALS
...
CHECK_FROM = "2025-06-01"   # widened from 2026-01-01: the pure-2026 holdout was only 362 matches, short of MIN_HOLDOUT
...
def main():
    ...
    if args.fit:
        out = os.path.join(HERE, "international-women.json")
        if args.dry_run:
